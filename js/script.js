...
var addressNode = document.querySelectorAll('.address');
var addressMenuNode = document.querySelector('.address-menu');
addressNode.forEach(function (elem) {
  elem.addEventListener('click', function () {
...
var productsTypeNode = document.querySelector('.products__dropdown-item');
var productsTypeMenu = document.querySelector('.products__droppdown-item-menu');
